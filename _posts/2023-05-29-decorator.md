...
데코레이터에서 받는 부분인데, 이는 wrapper 함수 안에 기존 함수의 리턴값을 저장해두고 wrapper에서 반환하도록 하여 기존 함수의 리턴값을 데코레이터를
사용하고도 내보낼 수 있다.
...
이 데코레이터를 사용하여 정적 메소드(static method)를 구현할 수 있다.


2. @classmethod

이 데코레이터를 사용하여 클래스 메소드(class method)를 구현할 수 있다.

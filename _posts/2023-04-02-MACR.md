...
> indirect path 에서의 effect 로 분해할 수 있다. Figure2 에서 보이는 3가지 그림은  TE 를 분해하는 논리적인 과정을 그림으로 나타낸 것이다. 여기서 우리는 Counterfactural reasoning, 반사실적 사고를 통해 causal effect를 구해볼 수 있다. 
